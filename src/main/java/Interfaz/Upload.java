...
public class Upload extends javax.swing.JFrame {
    ...
    public Upload(TextoGui textoGui) throws IOException {
        this.textoGui = textoGui;
        initComponents();
    ...
    private void searchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBActionPerformed
        FileFilter filter = new FileNameExtensionFilter("txt","json");
        ...
        if(option==JFileChooser.APPROVE_OPTION){
            try {
                ...
                textoGui.getTexto().setTexto(FileManager.readFile(filePath));
                this.setVisible(false);
            } catch (IOException ex) {
                System.out.println("Error en la ventana Upload");
